...
Scale.prototype = {
  ...
  get: function get(i) {
    i = typeof i === 'string' && i in _knowledge.knowledgejs.stepNumber ? _knowledge.knowledgejs.stepNumber[i] : i;
  ...
  interval: function interval(_interval) {
    _interval = typeof _interval === 'string' ? _interval2.Interval.toCoord(_interval) : _interval;
